...
看起来VC Dimenson很小，是因为没有把脑袋里的VC Dimenson算进去。
...
* Learner Overfit: pick $g_{2} \in \mathcal{H}_{2}$
...
* $R$ always wins in $E_{out}$ if $N$ small! 资料不够多，不要钻牛角尖。简单的hypothesis
更加好。
...
* if $f \not in \mathcal{H}$: something of $f$ cannot be captured by $\mathcal{H}$
